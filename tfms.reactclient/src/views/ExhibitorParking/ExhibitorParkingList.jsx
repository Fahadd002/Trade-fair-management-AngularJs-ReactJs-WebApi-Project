...
const columns = [
    ...
    return(
        <>
         <MUIDataTable title={"Bookings List"} data={parkings} columns={columns}
     options={{
         selectableRows: false, hover: false,
         customToolbar: () => <Fab sx={{ ml: 1 }} variant="extended" size="medium" href="/exhibitor-parking-create" color="primary"><AddIcon sx={{ mr: 1 }} /> Add New</Fab>,
